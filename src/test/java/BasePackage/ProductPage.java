...
//Add to cart product
    ...
    WebElement firstProductWithHoverAddtoCart;
    ...
    public void clickContinueShopping() {
        utility.clickElement(popContinueShopping);
    }

    public void funlinkviewcart()
    {
        utility.clickElement(linkViewCart);
    }

    public void fun2ndproduct()
    {
